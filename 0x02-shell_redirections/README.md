this file contains instructions to the tasks in the project.
...
Tast 17. I hate bins: Display all the lines in the file /etc/passwd that do not contain the pattern “bin”.
